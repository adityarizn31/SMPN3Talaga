...
if (isset($_POST['submit'])) {
  $insert = mysqli_query($conn, "INSERT INTO ppdb (nik, nokk, nisn, nama, tempatlahir, tanggalahir, jeniskelamin, agama, alamat, nama_ayah, nama_ibu, pekerjaan_ayah, pekerjaan_ibu, nohp) VALUES (
    '" . $_POST['nik'] . "',
    '" . $_POST['nokk'] . "',
    '" . $_POST['nisn'] . "',
    '" . $_POST['nama'] . "',
  ...
  if (mysqli_affected_rows($conn) > 0) {
    $sukses = "Selamat Pendaftaran Sukses !!";
  } else {
    $error = "Pendaftaran Gagal Mohon Isi dengan Teliti !!";
  }
}
  ...
  <div class="p-5-5-5  m-5 border-4 bd-example">
    ...
    <div class="row">
      ...
      <div class="card-body">
        ...
        <?php
          header("refresh:5;url=pendaftaran_siswa.php");
        }
        ?>
      ...
      <form action="" method="POST">
        ...
        <div class="form-group row">
          ...
          <div class="col-md-6">
            ...
            <input type="date" class="form-control" id="tanggalahir" name="tanggalahir" aria-describedby="tanggalahir">
          </div>
        </div>
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control" id="nama_ayah" name="nama_ayah" aria-describedby="ayah">
        </div>

        <div class="mb-3">
          <label for="InputIbu" class="form-label"> Nama Ibu </label>
          <input type="text" class="form-control" id="nama_ibu" name="nama_ibu" aria-describedby="ibu">
        </div>

        <div class="mb-3">
          <label for="pekerjaanayah" class="form-label"> Pekerjaan Ayah </label>
          <input type="text" class="form-control" id="pekerjaan_ayah" name="pekerjaan_ayah" aria-describedby="pekerjaan_ayah">
        </div>

        <div class="mb-3">
          <label for="pekerjaanibu" class="form-label"> Pekerjaan Ibu </label>
          <input type="text" class="form-control" id="pekerjaan_ibu" name="pekerjaan_ibu" aria-describedby="pekerjaan_ibu">
        </div>
