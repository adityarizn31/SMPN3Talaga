...
if (isset($_POST['simpan'])) {
  ...
  if ($nik && $nokk && $nisn && $nama && $tempatlahir && $tanggalahir && $jeniskelamin && $agama && $alamat && $nama_ayah && $nama_ibu && $pekerjaan_ayah && $pekerjaan_ibu && $nohp) {
    if ($op == 'edit') { // Untuk Update
      ...
      $sql1 = "INSERT INTO ppdb (nik, nokk, nisn, nama, tempatlahir, tanggalahir, jeniskelamin, agama, alamat, nama_ayah, nama_ibu, pekerjaan_ayah, pekerjaan_ibu, nohp) VALUES ('$nik', '$nokk', '$nisn', '$nama', '$tempatlahir', '$tanggalahir', '$jeniskelamin', '$agama', '$alamat', '$nama_ayah', '$nama_ibu', '$pekerjaan_ayah', '$pekerjaan_ibu', '$nohp')";
      $q1 = mysqli_query($conn, $sql1);
      if ($q1) {
  ...
  <div class="mx-auto">
    <div class="card">
      ...
      <div class="card-body">
        ...
        <?php
          header("refresh:15;url=dash_ppdb.php");
        }
        ?>
        ...
        <form action="" method="POST">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="nokk" name="nokk" value="<?php echo $nokk ?>">
          </div>
          ...
          <div class="mb-3 row">
            <label for="nohp" class="col-sm-2 col-form-label">No Hp/WA</label>
            <div class="col-sm-10">
