...
<head>
  ...
  <title> Guru || SMPN 3 Talaga </title>
    ...
    <div class="container-login100">
      <div class="wrap-login100">
        ...
        if (isset($_POST['submit'])) {
          ...
          $cek = mysqli_query($conn, "SELECT * FROM guru WHERE username = '" . $user . "' ");
          if (mysqli_num_rows($cek) > 0) {
            ...
            if (md5($pass == $d->password)) {
              ...
              $_SESSION['umatpel']           = $d->matpel;

              echo "<script> window.location = 'dashboard_guru.php' </script>";
            } else {
