  ...
  <div class="mx-auto">
    <div class="card">
      ...
      <div class="card-body">
        ...
        <?php
          header("refresh:15;url=dash_admin.php");
        }
        ?>
          ...
          <tbody>
            ...
            ?>
              <tr>
                ...
                <th scope="row">
                  <a href="dash_admin.php?op=edit&id=<?php echo $id ?>"><button type="button" class="btn btn-warning">Edit</button></a>
                  <a href="dash_admin.php?op=delete&id=<?php echo $id ?>" onclick="return confirm('Yakin mau hapus data ??')"><button type="button" class="btn btn-danger">Delete</button></a>
                </th>
              </tr>
            <?php
            }
